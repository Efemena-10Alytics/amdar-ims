        ...
        <div className="max-w-325 mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="hidden lg:flex flex-col gap-1 h-full absolute left-1/2 top-0 bottom-0 w-1.5 transform -translate-x-1/2 z-0">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 relative z-10">
                ...
                <div className="flex flex-col gap-6 lg:gap-8">
                  {steps
                    ...
                    .map((step) => (
                      <div key={step.number} className="lg:pr-8">
                        {/* Step Box */}
                        <div className="bg-[#0F4652] rounded-xl p-4 lg:p-6 flex items-center gap-4">
                          {/* Number Badge */}
                          <div className="shrink-0">
                            <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-full bg-[#156374] flex items-center justify-center">
                ...
                <div className="flex flex-col gap-6 lg:gap-8 lg:mt-12">
                  {steps
                    ...
                    .map((step) => (
                      <div key={step.number} className="lg:pl-8">
                        {/* Step Box */}
                        <div className="bg-[#0F4652] rounded-xl p-4 lg:p-6 flex items-center gap-4">
                          {/* Number Badge */}
                          <div className="shrink-0">
