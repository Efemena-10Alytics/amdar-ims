...
const STRUCTURE_VIDEO_SRC = "https://vimeo.com/1123856639";

const CareerInternshipStructureVideo = () => {
  ...
  return (
    <section className="w-full max-w-190 px-4 pb-5 pt-0 sm:px-0 sm:pb-8">
      <h1 className="text-2xl font-semibold text-[#173740]">Career knowledge discovery 1</h1>
      ...
      <article className="mt-5 rounded-2xl border border-[#DCE5E9] bg-[#F6F8FA] p-4 shadow-[0_8px_18px_rgba(18,57,67,0.06)] sm:p-5">
        ...
        <p className="mt-3 text-base leading-relaxed font-semibold text-[#64748B]">
          Getting to know how your internship works
        </p>
      </article>
      ...
      <button
        ...
        onClick={() => router.push("/pre-diagnostic-test?step=cohort-lead")}
...
export default CareerInternshipStructureVideo;
