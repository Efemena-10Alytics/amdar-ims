...
const INITIAL_FORM_STATE: CvReviewFormState = {
  roleTitle: "",
  companyName: "",
  companyLocation: "",
  cvFile: null,
...
const CvReviewDrawer = ({ open, onOpenChange }: CvReviewDrawerProps) => {
  const cvInputId = useId();
  const cvInputRef = useRef<HTMLInputElement>(null);

  const [form, setForm] = useState<CvReviewFormState>(INITIAL_FORM_STATE);
        ...
        <form onSubmit={handleSubmit} className="flex h-full flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5">
            ...
            <div className="mt-3 space-y-4">
              ...
              <div>
                <label
                  htmlFor="cv-review-company-name"
                  className="mb-1.5 block text-sm font-medium text-[#092A31]"
                >
                  Company name
                </label>
                <Input
                  id="cv-review-company-name"
