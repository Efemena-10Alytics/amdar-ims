  ...
  return (
    <section className="app-width pb-14 pt-4 lg:pb-20">
      ...
      <div className="relative pt-12">
        <div className="pointer-events-none absolute inset-x-0 -top-10 z-0 hidden md:grid md:grid-cols-3">
        ...
        <div className="relative z-10 grid gap-4 md:grid-cols-3">
          {unlockItems.map((item) => {
            ...
            return (
              <div key={item.number} className="rounded-xl border border-[#5D7D8A80] bg-[#111A2A] p-4">
