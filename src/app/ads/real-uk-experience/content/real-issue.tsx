...
const RealIssue = () => {
  return (
    <section className="app-width pb-14 pt-6 lg:pb-20">
      ...
      <div className="rounded-2xl border-l-4 border-l-[#EF4444] border border-[#00FD931A] bg-[#031118D9] p-5 shadow-[0_0_24px_rgba(2,221,188,0.12)] sm:p-6">
        <ul className="space-y-3">
          {issuePoints.map((point) => (
            <li key={point} className="flex items-start gap-3 text-xl leading-snug text-[#DDE8EA]">
        ...
        <p className="mt-4 text-xl leading-snug text-[#DDE8EA]">
