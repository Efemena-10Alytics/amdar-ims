...
const WHATSAPP_LINK = "https://chat.whatsapp.com/FYVmrUfwzpGA5XOAlVKW0d";
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-16">
        <div className="w-full max-w-[480px] rounded-2xl border border-[#156374]/45 bg-[#0C3640] px-7 py-10 text-center">
          ...
          <p className="mb-8 text-[15px] leading-[1.65] text-[#C7D5D6]">
            Check your inbox — we&apos;ll be in touch with the joining link and
            everything you need to prepare for the panel. Join the WhatsApp
            community below to stay updated and connect with other attendees.
          </p>
